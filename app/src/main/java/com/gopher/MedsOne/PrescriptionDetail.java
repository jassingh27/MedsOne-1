...
import com.gopher.MedsOne.databinding.ActivityPrescriptionDetailBinding;
...
public class PrescriptionDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_prescription_detail);
